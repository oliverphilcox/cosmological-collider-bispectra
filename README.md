...
The binary data file `shape_data.bin` (6.7 MB) contains pre-computed bootstrap exchange shapes and k-space binning. It is generated by `prepare_web_data.py` in the [PolySpec](https://github.com/oliverphilcox/PolySpec) repository.
